...
int main() {
    int arr[100];
    int n = 0, i, choice, pos, value, found;
    ...
    do {
        printf("\n__________________ Quan ly danh sach so nguyen __________________\n");
        printf("1. Them phan tu vao vi tri bat ky\n");
        printf("2. Xoa phan tu o vi tri bat ky\n");
        printf("3. Cap nhat gia tri o vi tri bat ky\n");
        printf("4. Search phan tu trong mang\n");
        printf("5. Hien thi mang\n");
        printf("6. Quit chuong trinh\n");
